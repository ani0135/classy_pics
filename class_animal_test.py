...
# def predict_alphanumeric(value):
#     value = int(value)
...
#     save_image(x, f'static/Predicted_Image/{value}.png')
#     path = os.path.join("static/Predicted_Image/",str(value)+".png")
#     return path

f = open('label_animal.json')
class_label = json.load(f)
model.load_state_dict(torch.load("Checkpoint/Checkpoint_1/model_animal_10.pt"))
model.eval()
...
#     path_var = predict_alphanumeric(id)
#     print(path_var)

#     return send_file(path_var, mimetype='image/png')
